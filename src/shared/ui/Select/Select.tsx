  ...
  return (
    <SelectPrimitive.Root {...props}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content css={selectContentStyle}>
          <SelectPrimitive.ScrollUpButton css={selectScrollButtonStyle}>
            <ChevronUpIcon />
          </SelectPrimitive.ScrollUpButton>
          <SelectPrimitive.Viewport css={selectViewportStyle}>
            {children}
          </SelectPrimitive.Viewport>
          <SelectPrimitive.ScrollDownButton css={selectScrollButtonStyle}>
            <ChevronDownIcon />
